...
<?php include_once 'navigationbar.php'?>
    ...
    <div class="container">
        <div class="card">
            <img src="downloadp1.jpg" alt="Gym with Coach - 3 Months">
            <div class="text">
                ...
                <a href="Payment.php"><button class="btn" >Get Started</button></a>
            </div>
        </div>

        <div class="card">
            <img src="imagesp2.jpg" alt="Gym with Coach - 6 Months">
            <div class="text">
                <h2>Workout and Nutrition plan</h2>
        ...
        <div class="card">
            <img src="downloadp3.jpg" alt="Gym with Coach - 12 Months">
            <div class="text">
                <h2>Workout and Nutrition plan</h2>
