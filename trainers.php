      ...
      <div class="About-Trainers-grid">
        <div class="Trainers-card">
          <div class="Trainers-img">
            <img src="freepik__expand__10289.png" alt="Female Trainers"/>
          </div>
        ...
        <div class="Trainers-card">
          <div class="Trainers-img">
            <img src="people-working-out-indoors-together-with-dumbbells.jpg" alt="Fitness Trainers"/>
          </div>
          <div class="Trainers-info">
        ...
        <div class="Trainers-card">
          <div class="Trainers-img">
            <img src="two-internationals-friends-is-engaged-gym.jpg" alt="Sport Trainers"/>
          </div>
          <div class="Trainers-info">
